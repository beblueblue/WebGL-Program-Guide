<template>
    <div>
        ...
        <div class="mt10"><a class="blue" @click="openHiddenFace = !openHiddenFace">{{ openHiddenFace ? '关闭' : '开启'}}隐藏面消除</a></div>
        <div class="mt10">
            顶点数组：
<pre>
    [
         0.0,  1.0, 0.0, 0.4, 0.4, 1.0, // 蓝色三角形
        -0.5, -1.0, 0.0, 0.4, 0.4, 1.0,
         0.5, -1.0, 0.0, 1.0, 0.4, 0.4,

         0.0,  1.0, -4.0, 0.4, 1.0, 0.4, // 绿色三角形
        -0.5, -1.0, -4.0, 0.4, 1.0, 0.4,
         0.5, -1.0, -4.0, 1.0, 0.4, 0.4,

         0.0,  1.0, -2.0, 1.0, 0.4, 0.4, // 黄色三角形
