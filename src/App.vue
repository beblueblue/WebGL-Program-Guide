<template>
  <div id="app">
    <h1 class="tc mt30 mb30">Hello, GLSL!</h1>
    <div class="display-flex ml30 mr30">
      <ul class="demo-title-box">
        ...
        <router-link to="MultiPoint" tag="li" class="mt10"><span class="fb">MultiPoint</span>: 利用buffer object绘制多个点</router-link>
